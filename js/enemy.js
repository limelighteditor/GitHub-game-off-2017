...
function enemy_init() {
  ...
  enemy.stats[ENEMY_IMP] = {name:"Goblin", hp:7, atk_min:2, atk_max:6, gold_min:1, gold_max:3, category:ENEMY_CATEGORY_DEMON};
  ...
  enemy.stats[ENEMY_DRUID] = {name:"Drok", hp:16, atk_min:7, atk_max:14, gold_min:7, gold_max:12, category:ENEMY_CATEGORY_DEMON};
  ...
  enemy.stats[ENEMY_DEATH_SPEAKER] = {name:"Enchantress", hp:84, atk_min:8, atk_max:15, gold_min:225, gold_max:275, category:ENEMY_CATEGORY_DEMON};
